...
type ModuleType = 'Grocery' | 'Food' | 'Pharmacy' | 'Ecommerce' | 'Parcel';
...
const AddBusinessModule = () => {
  ...
  const handleReset = () => {
    ...
    setSelectedModule("" as "" | ModuleType); // Type assertion to fix type mismatch
    setIcon(null);
    setThumbnail(null);
    setError("");
    setSuccess("");
  ...
  const handleSubmit = async () => {
    ...
    if (!selectedModule) {
      setError("Please select a business module type");
      return;
    }
    
    if (!icon || !thumbnail) {
      setError("Both icon and thumbnail images are required");
      return;
    }
    ...
    try {
      ...
      const moduleData = {
        ...
        status: 'active',
        features: [selectedModule],
        config: {
          language,
          icon: icon, // In a real implementation, you would upload these images to a server
          thumbnail: thumbnail, // and store the URLs instead of the file objects
          type: selectedModule
        }
      };
      ...
      setSuccess("Business module created successfully!");
      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        {error && (
          <div className="bg-red-50 border-l-4 border-red-400 p-4 mb-6 flex justify-between items-center">
            ...
            <button className="text-red-400 hover:text-red-600" onClick={() => setError("")}>
        ...
        {/* Success Alert - Only shown when there's a success message */}
        {success && (
          <div className="bg-green-50 border-l-4 border-green-400 p-4 mb-6 flex justify-between items-center">
            ...
            <button className="text-green-400 hover:text-green-600" onClick={() => setSuccess("")}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
              </svg>
            </button>
      ...
      <div className="p-6 max-w-6xl mx-auto">
                ...
                <li key={module}>
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      onChange={() => setSelectedModule(module as ModuleType)}
        ...
        <div className="flex justify-end gap-4 mt-6">
          ...
          <button
            ...
            className={`px-6 py-2 rounded-lg ${isSubmitting ? 'bg-teal-500 cursor-not-allowed' : 'bg-teal-700 hover:bg-teal-800'} text-white flex items-center`}
          >
            {isSubmitting ? (
              <>
