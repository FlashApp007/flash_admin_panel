...
const SearchingDeliverymenOrdersFull: React.FC = () => {
  return (
    <div className="bg-gray-50 min-h-screen p-6">
      ...
      <div className="flex items-center mb-4">
        ...
        <span className="bg-gray-200 text-gray-700 text-xs px-2 py-0.5 rounded font-semibold">13</span>
      </div>
      {/* Card */}
...
export default SearchingDeliverymenOrdersFull;
