    ...
    <div className="max-w-7xl mx-auto mt-8">
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="font-semibold text-base">Searching For Deliverymen Orders</span>
            ...
            <tbody>
              {orders.map((order, idx) => (
                <tr key={order.id} className="bg-white border-b last:border-b-0">
                  ...
                  <td className="px-3 py-2 text-left whitespace-nowrap">
                    <span className={`px-3 py-1 rounded-full text-xs font-semibold ${order.status === 'Confirmed' ? 'bg-teal-50 text-teal-600 border border-teal-200' : 'bg-teal-50 text-teal-600 border border-teal-200'}`}>
                      {order.status}
                    </span>
                  </td>
