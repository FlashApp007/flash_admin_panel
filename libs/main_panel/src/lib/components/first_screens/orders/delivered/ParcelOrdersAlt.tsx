...
const orders = [
  ...
  {
    id: '100042',
    date: '29 Sep 2022 02:47PM',
    customer: 'Akram Khan',
    contact: '8***********',
    category: 'Package',
    paymentBy: 'Sender',
    paymentMethod: 'Ssl commerz payment',
    amount: '$ 109.98',
    paid: true,
    status: 'Delivered',
  },
            ...
            <tbody>
              {orders.map((order, idx) => (
                <tr key={order.id} className={idx % 2 === 1 ? "bg-[#f7fafd] border-b last:border-b-0" : "bg-white border-b last:border-b-0"}>
                  ...
                  <td className="px-3 py-2 text-left whitespace-nowrap">{order.category}</td>
                  <td className="px-3 py-2 text-left whitespace-nowrap">
                  ...
                  <td className="px-3 py-2 text-left whitespace-nowrap">
                    {order.status === 'Delivered' && (
                      <span className="px-3 py-1 rounded-full text-xs font-semibold bg-teal-50 text-teal-600 border border-teal-200">Delivered</span>
                    )}
                  </td>
