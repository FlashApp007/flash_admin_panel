                ...
                <tr key={order.id} className={idx % 2 === 1 ? "bg-[#f7fafd] border-b last:border-b-0" : "bg-white border-b last:border-b-0"}>
                  ...
                  <td className="px-3 py-2 text-left whitespace-nowrap">
                    {order.status === 'Confirmed' && (
                      <span className="px-3 py-1 rounded-full text-xs font-semibold bg-teal-50 text-teal-600 border border-teal-200">Confirmed</span>
                    )}
                    {order.status === 'Handover' && (
                      <span className="px-3 py-1 rounded-full text-xs font-semibold bg-pink-50 text-pink-600 border border-pink-200">Handover</span>
                    )}
                  </td>
